...
while true; do
    ...
    do
        ...
        JSON="data/gfs_850_f${FILE_FHR}.json"

        echo "📥 Downloading GFS ${DATE} ${CYCLE}z +${FILE_FHR}h..."
    
        URL="https://nomads.ncep.noaa.gov/cgi-bin/filter_gfs_0p25.pl?file=gfs.t${CYCLE}z.pgrb2.0p25.f${FILE_FHR}&var_UGRD=on&var_VGRD=on&lev_850_mb=on&dir=%2Fgfs.${DATE}%2F${CYCLE}%2Fatmos"
